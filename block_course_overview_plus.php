...
class block_course_overview_plus extends block_base {
   ...
   if ($term != '0') {
        set_user_preference('courseoverviewplusselectedterm', $term, $USER->id);
        $currentterm=$term;
    } else {
        $currentterm = get_user_preferences('courseoverviewplusselectedterm', 'all');
   }
...
//              set_user_preference('courseoverviewplusselectedyear', $currentyear, $USER->id);
  ...
  //            set_user_preference('courseoverviewplusselectedyear', $currentyear, $USER->id);
	...
	if ($this->config->categorycoursefilter || $this->config->yearcoursefilter || $this->config->termcoursefilter) {
            ...
            echo '</td><td>';
            if($this->config->termcoursefilter) {
                echo get_string('term', 'block_course_overview_plus');
            } 
            echo '</td><td rowspan=2><input type="image" alt="'.get_string('clicktofilter', 'block_course_overview_plus').'" src="'.$CFG->wwwroot.'/blocks/course_overview_plus/pix/i/course_filter.png"/></td></tr><tr><td>';
            if($this->config->yearcoursefilter) {
            ...
            if($this->config->termcoursefilter) {
                ...
                if (isset($terms['fall'])) {
                  if($currentterm == 'fall') {
                    echo '<option value="fall" selected>'.get_string('fall', 'block_course_overview_plus').'</option> ';
                    $selectedavailable = true;
                  } else {
                    echo '<option value="fall">'.get_string('fall', 'block_course_overview_plus').'</option> ';
                  }
               }                
               if (isset($terms['spring'])) {
                  if($currentterm == 'spring') {
                    echo '<option value="spring" selected>'.get_string('spring', 'block_course_overview_plus').'</option> ';
                    $selectedavailable = true;
                  } else {
                    echo '<option value="spring">'.get_string('spring', 'block_course_overview_plus').'</option> ';
                  }
               }
               if (isset($terms['other'])) {
                  if($currentterm == 'other') {
                    echo '<option value="other" selected>'.get_string('other', 'block_course_overview_plus').'</option> ';
                    $selectedavailable = true;
                  } else {
                    echo '<option value="other">'.get_string('other', 'block_course_overview_plus').'</option> ';
                  }
             ...
             //  }
              ...
              if (!$selectedavailable) {
                 $currentterm = 'all';
                 set_user_preference('courseoverviewplusselectedterm', $currentterm, $USER->id);
               }
...
id="contract'.$c->id.'" title="'.get_string('collapsecourseinfo', 'block_course_overview_plus').'">'.
                     '<img src="'.$CFG->wwwroot.'/blocks/course_overview_plus/pix/i/contract.gif" class="icon" alt="'.get_string('collapsecourseinfo', 'block_course_overview_plus').'" /></a>'.
...
title="'.get_string('expandcourseinfo', 'block_course_overview_plus').'">'.
                     '<img src="'.$CFG->wwwroot.'/blocks/course_overview_plus/pix/i/expand.gif" class="icon" alt="'.get_string('expandcourseinfo', 'block_course_overview_plus').'" 
/></a></div>';
          } else {
...
'block_course_overview_plus').'" id="expand'.$c->id.'" >'.
                     '<img src="'.$CFG->wwwroot.'/blocks/course_overview_plus/pix/i/expand.gif" alt="'.get_string('expandcourseinfo', 'block_course_overview_plus').'" 
class="icon"/></a></div>';
          }
     }
      echo $OUTPUT->box_end();
...
if ($this->config->termcoursefilter||$this->config->yearcoursefilter||$this->config->categorycoursefilter) { 
