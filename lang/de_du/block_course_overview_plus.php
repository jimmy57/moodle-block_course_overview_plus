...
$string['expandcourseinfo'] = 'Kursinformationen anzeigen';
$string['collapsecourseinfo'] = 'Kursinformationen verbergen';
$string['hidecourse'] = 'Kurs anzeigen';
$string['showcourse'] = 'Kurs verbergen';
$string['youhave'] = 'Du hast';
